...
DOMAIN = "cloudmigration"
DOMAIN_UPPER = "CLOUDMIGRATION"
MCP_SERVER_DIR = "cloudmigration-mcp-server"
MCP_SERVER_NAME = "上云大数据"
REPORT_BANNER = "上云大数据报告"
REPORT_TYPE = "cloudmigration_analysis"
